const LOCAL_RECOMMENDATION_API_BASE_URL = "http://127.0.0.1:8124/api/v1";
export const DEFAULT_RECOMMENDATION_API_BASE_URL = String(
  globalThis.XUHUI_RECOMMENDATION_API_BASE_URL || LOCAL_RECOMMENDATION_API_BASE_URL,
).trim().replace(/\/$/, "");
