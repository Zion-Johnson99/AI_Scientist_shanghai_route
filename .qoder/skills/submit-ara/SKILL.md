...
`references/upload-and-hub.md`（相对于本 Skill 目录）§Publish. In summary:
...
Hub landing page. Details in `references/upload-and-hub.md`（相对于本 Skill 目录）§Register.
...
Load on demand:
- `references/upload-and-hub.md` — exact gh/git publish commands, slug
