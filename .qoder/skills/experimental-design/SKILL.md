...
description: Design experiments before data collection, including randomization, blocking, treatment assignment, factorial and fractional-factorial designs, response-surface optimization, crossover, repeated-measures, split-plot, cluster randomization, Latin squares, plate layouts, batch effects, replication, and sequential or adaptive designs. Use when planning a study, assigning subjects or samples, avoiding confounding, screening factors, or asking how to set up an experiment. For sample size or power after choosing the design, use statistical-power; for analysis of collected data, use statistical-analysis.
